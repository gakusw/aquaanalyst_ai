...
class AppColors {
  // Brand Categories
  static const Color pool = Color(0xFF22D3EE);    // Cyan
  ...
  static const Color sleep = Color(0xFFA78BFA);   // Violet/Lavender
  ...
  static Color getEffectiveColor(BuildContext context, Color color) {
    if (Theme.of(context).brightness == Brightness.light) {
      ...
      if (color == pool) return Colors.cyan.shade800;
      ...
      if (color == sleep) return Colors.indigo.shade800;
    }
    return color;
  }
}
