...
class AppColors {
  // Brand Categories
  static const Color pool = Color(0xFF172554);    // Darker Blue / Navy (Improved visibility)
  ...
  static Color getEffectiveColor(BuildContext context, Color color) {
    if (Theme.of(context).brightness == Brightness.light) {
      ...
      if (color == pool) return const Color(0xFF1E3A8A); // Slightly lighter than base for light mode but still dark
